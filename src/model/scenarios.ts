...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    name: "WTC 7",
    short: "47 · fire only",
    blurb: "No airplane. 47 stories, a conventional frame, not a tube. Debris fires on 7–9. Beams expand. The girder walks off the seat at column 79. Then that strut has nothing to lean on. 80 and 81 follow — they only shared load through those floors. Historically ~7 hours, then the east penthouse, then the shell.",
    brief: "No airplane. Debris fires on stories 7–9. Floor beams expand. The girder walks off the seat at column 79. Then the strut buckles.",
    world: "tower",
    shape: "tower",
    floors: 47,
    floorH: 3.92,
